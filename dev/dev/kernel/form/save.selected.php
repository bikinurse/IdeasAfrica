...
$existing_value = DBase::table_row_ids("$table where company_id = '$company_id' and ".$table_fields[2]."='".$value_details['id']."'");
//print_r($existing_value);


if(count($existing_value)==0){
	
	$sql = "insert into $table (company_id,".$table_fields[2].") values('$company_id','".$value_details['id']."')";
