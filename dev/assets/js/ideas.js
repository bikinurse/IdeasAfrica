...
function get_followers(id,type){
$('#follow_details').html('<div align="center"><img id="loader"  src="http://localhost/dev/assets/img/loader.gif" alt="loading..." /></div>');
        $.ajax({
            url: 'kernel/following.php',
            type:"POST",
            data:'type=person&id='+id+'&type='+type,
            async:false,
            success:function(data){
                $('#loader').hide();
                $('#follow_details').html(data);
            }
        })
