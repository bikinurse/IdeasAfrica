...
class DBase{
	...
	public static function db_tables(){
		$tables = array();
		$db = mysql_connect('localhost','ideasafr_ica','ideasafr_ica');
		$sql = "show tables";
	...
	public static function table_column($fieldName,$table){
		$values = array();
	...
	public static function table_row_by_user_id($table, $user_id){
